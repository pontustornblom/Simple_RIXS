#input_spring_8_file_information_script
import sys
import os
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):      
        ...
        if self.parameters["plot_type"]== "Make treated RIXS data from SPring-8 BL27SU":
            ...
            self.vbox.addLayout(self.create_gui_item("input_file_iteratable_file_number_start", "First iteratable file number (The number before .dat): ", "q_line_edit", [""]))
            ...
            #self.vbox.addLayout(self.create_gui_item("is_x_values_available_in_file", "Would you like to ignore the given x-axis and create your own x-axis based on the elastic peaks of this spectra?", "q_check_box", [""]))

        elif self.parameters["plot_type"][:3]=="XAS":
            self.vbox.addLayout(self.create_gui_item("input_complete_file_name", "Input complete file name of the raw data: ", "q_line_edit", [""]))

        self.vbox.addLayout(self.create_gui_item("complete_i0_file_location", "Input the file locaion for the I0 file: ", "q_line_edit", [""]))
        self.vbox.addLayout(self.create_gui_item("input_file_iteratable_file_number_start_2", "First iteratable file number for the i0 values (The number before _1.dat): ", "q_line_edit", [""]))
        self.vbox.addLayout(self.create_gui_item("input_file_iteratable_file_number_end_2", "Last iteratable file number for the i0 values: ", "q_line_edit", [""]))
        ...
        self.setWindowTitle("Simple RIXS Input SPring-8 data information")
        self.show()
