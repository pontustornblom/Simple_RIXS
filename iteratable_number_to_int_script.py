#iteratable_number_to_int_script

def iteratable_number_to_int(iteratable_number):
    ...
    if iteratable_file_number_length != 1:
        ...
        if number_of_zeros_in_iteratable_number == iteratable_file_number_length:
            ...
            iteratable_file_number_int = int(iteratable_number[number_of_zeros_in_iteratable_number:])
    else:
        iteratable_file_number_int = int(iteratable_number)
