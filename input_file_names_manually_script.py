#input_file_names_manually_script
import sys
import os
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):      
        ...
        self.vbox.addLayout(self.create_gui_item("input_number_of_complete_file_names", "How many spectra are in the RIXS map?  \nThe number is only for certain file systems where more than one spectra is stored in each file. \nCan be left blank if there is only one spectra per file.", "q_line_edit", [""]))
        ...
        self.setWindowTitle("Simple RIXS Input file names manually")
        self.show()
