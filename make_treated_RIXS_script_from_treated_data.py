#make_treated_RIXS_script_from_treated_data
import sys
import os
import platform
import subprocess
...
class MainWindow(QMainWindow):
    ...
    def add_intensities_of_same_excitation_energy(self, array_of_x_value_arrays, incoming_energy_array, array_of_intensity_arrays):
        ...
        for energy_index, excitation_energy in enumerate(unique_excitation_energies_list):
            indices_of_same_energy_array = [i for i, x in enumerate(incoming_energy_array) if np.abs(x - excitation_energy) < energy_mismatch_tolerance]
        ...
        print(array_of_combined_intensity_arrays)
